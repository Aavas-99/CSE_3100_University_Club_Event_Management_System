...
<head>
    ...
    <style> .form-card{max-width:900px}</style>
</head>
<body class="min-h-screen bg-slate-100 flex items-center justify-center px-4 py-8">
    <div class="w-full form-card rounded-2xl bg-white p-8 shadow-xl">
        <div class="text-center mb-6">
            <h1 class="text-2xl font-bold text-slate-800">Create Your KUET EMS Student Account</h1>
            <p class="text-sm text-slate-500">Register to browse and join university events</p>
        </div>
        <form method="POST" action="{{ route('register') }}" class="space-y-4">
            ...
            <button type="submit" class="w-full rounded-lg bg-green-700 px-4 py-2 font-semibold text-white">Register as Student</button>
        </form>
