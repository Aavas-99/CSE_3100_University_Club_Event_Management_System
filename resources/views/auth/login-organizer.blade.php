                ...
                <div x-data="{ showPass: false }">
                    ...
                    <div class="relative">
                        ...
                        <input :type="showPass ? 'text' : 'password'" name="password" required
                            class="w-full pl-11 pr-10 py-3 rounded-xl bg-white/5 border border-white/10 text-white text-sm placeholder-slate-500 focus:outline-none focus:border-kuet-500 focus:ring-1 focus:ring-kuet-500 transition-all"
