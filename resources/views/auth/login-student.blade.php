...
<head>
    ...
    <title>Student Login | KUET EMS</title>
    ...
    <div class="relative w-full max-w-md">
        ...
        <div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-2xl font-bold text-white">Student Sign In</h1>
                <p class="text-slate-400 text-sm mt-1">Access your student portal</p>
            </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" required
                            class="w-full pl-11 pr-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white text-sm placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all"
                            placeholder="your.email@kuet.ac.bd">
                    </div>
                </div>
                ...
                <div x-data="{ showPass: false }">
                    ...
                    <div class="relative">
                        ...
                        <input :type="showPass ? 'text' : 'password'" name="password" required
                            class="w-full pl-11 pr-10 py-3 rounded-xl bg-white/5 border border-white/10 text-white text-sm placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all"
            ...
            <div class="mt-6 pt-6 border-t border-white/10 text-center">
                <p class="text-sm text-slate-400">
                    New student? <a href="{{ route('register') }}" class="text-blue-400 font-semibold hover:text-blue-300 transition-colors">Create account</a>
                </p>
            </div>
        </div>
